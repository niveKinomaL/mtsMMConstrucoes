...
export default function EditProduct({
  ...
  useEffect(() => {
    setName(productName);
    setAmount(formatToBRL(inititalAmount));
    setAmount2(formatToBRL(inititalAmount2));
    setTypeProduct(inititalTypeProduct);
